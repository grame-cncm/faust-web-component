...
## NPM package 
 ...
 A [npm package](https://www.npmjs.com/package/@grame/faust-web-component) can be used with the CDN link: https://cdn.jsdelivr.net/npm/@grame/faust-web-component@0.5.8/dist/faust-web-component.js (possibly update the version number).
...
<script src="https://cdn.jsdelivr.net/npm/@grame/faust-web-component@0.5.8/dist/faust-web-component.js"></script>
```
